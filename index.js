...
let data = {
	        ...
	        email: 'john@mail.org',
	        height: 140,
	        phone: '08912345678912',
	        createdAt: new Date().toISOString(),
	        updatedAt: new Date().toISOString()
    	}
function addData(data) {
  db.Student.create({firstname: data.firstname, lastname: data.lastname, birthdate: data.birthdate, email: data.email, height: data.height, phone: data.phone})
  .then(function(){
